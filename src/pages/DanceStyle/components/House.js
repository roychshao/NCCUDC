        ...
        <div>
            ...
            <Carousel variant="light">
                <Carousel.Item interval={6000}>
                    <Image fluid src={h1} alt="house" height="550px" width="100%"/>
                    <Carousel.Caption>
                        <h3>起源於當時派對的互動社交舞蹈，並與當時美國東岸盛行的Hip Hop、Breaking等街舞風格有深刻的交互影響。</h3>
                    </Carousel.Caption>
                </Carousel.Item>
                <Carousel.Item interval={6000}>
                    <Image fluid src={h2} alt="house" height="550px" width="100%"/>
                    <Carousel.Caption>
                        <h3>House從Jazz、踢踏、Capoeira、Bebop Jazz、非洲舞等風格中汲取養分，在視覺上非常強調腳步的節奏變化以及延續不斷的韻律感。</h3>
                    </Carousel.Caption>
                </Carousel.Item>
                <Carousel.Item interval={6000}>
                    <Image fluid src={h3} alt="house" height="550px" width="100%"/>
                    <Carousel.Caption>
