        ...
        <div>
            ...
            <Carousel variant="light">
                <Carousel.Item interval={6000}>
                    <Image fluid src={hh1} alt="hiphop" height="550px" width="1000px"/>
                    <Carousel.Caption>
                        <h3>Hip-Hop是一種融合技巧的自由舞蹈風格，是一種源自於嘻哈文化和其他文化影響開始的社交舞蹈。</h3>
                    </Carousel.Caption>
                </Carousel.Item>
                <Carousel.Item interval={6000}>
                    <Image fluid src={hh2} alt="hiphop" height="550px" width="1000px"/>
                    <Carousel.Caption>
                        <h3>Hip-Hop可以包含其他舞蹈形式，從日常生活到自然到甚至電影的虛構角色。</h3>
                    </Carousel.Caption>
                </Carousel.Item>
                <Carousel.Item interval={6000}>
                    <Image fluid src={hh3} alt="hiphop" height="550px" width="1000px"/>
                    <Carousel.Caption>
